...
class QM9(InMemoryDataset):
    ...
    def raw_file_names(self) -> List[str]:
        try:
            import rdkit  # noqa
            return ['gdb9.sdf', 'gdb9.sdf.csv', 'uncharacterized.txt', 'smi_qm9.csv']
        except ImportError:
    ...
    def process(self):
        ...
        with open(self.raw_paths[3], 'r') as f:
            lines = f.read().split('\n')[1:-1]
            smiles = [line.split(',')[20] for line in lines]        
        ...
        for i, mol in enumerate(tqdm(suppl)):
            ...
            data = Data(x=x, z=z, pos=pos, edge_index=edge_index, smi=smiles[i],
